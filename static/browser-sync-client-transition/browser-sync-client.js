...
! function t(e, n, o) {
    ...
    4: [function(t, e, n) {
        ...
        c.init = function(t) {
            ...
            classes = classes.replace(/( )?browser-sync/g, "");
            classes += ((classes=="") ? "" : " ") + "browser-sync";
            d.className = classes;
            ...
            if ("*" === e[0]) return t;
            for (var o = [], r = 0, i = t.length; i > r; r += 1) - 1 !== t[r][n].indexOf(e) && o.push(t[r]);
            return o
