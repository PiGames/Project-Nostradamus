...
export default class Game extends Phaser.State {
  create() {
    ...
    this.zombies.add( new Zombie( this.game, 'zombie', PLAYER_INITIAL_FRAME, [ { x: 4, y: 2 }, { x: 4, y: 6 } ], this.map.walls, this.player ) );
    this.zombies.add( new Zombie( this.game, 'zombie', PLAYER_INITIAL_FRAME, [ { x: 2, y: 2 }, { x: 7, y: 7 } ], this.map.walls, this.player ) );
